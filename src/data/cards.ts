...
const TRUTH_SEEDS: Array<[string, Category, GameMode[], 1 | 2 | 3 | 4 | 5]> = [
  ...
  // Romance / Couple — fokus kehidupan sehari-hari berdua
  ["Siapa yang biasanya bangun lebih dulu kalau kalian nginep / bareng?", "romance", COUPLE_MODES, 1],
  ["Pagi-pagi, kamu orang yang langsung aktif atau butuh waktu dulu?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih sering masak, dan siapa yang cuci piring?", "romance", COUPLE_MODES, 1],
  ["Makanan yang paling sering kalian pesan bareng apa?", "romance", COUPLE_MODES, 1],
  ["Kalau lagi lapar malam-malam, biasanya ngapain?", "romance", COUPLE_MODES, 1],
  ["Siapa yang pegang remote TV di rumah?", "romance", COUPLE_MODES, 1],
  ["Film atau series apa yang lagi kalian tonton bareng?", "romance", COUPLE_MODES, 1],
  ["Kalau lagi males keluar, idealnya di rumah ngapain berdua?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih sering telat janji ketemu?", "romance", COUPLE_MODES, 1],
  ["Biasanya kalian chat seharian atau cuma jam-jam tertentu?", "romance", COUPLE_MODES, 1],
  ["Panggilan di chat kalian apa? (sayang, bebeb, dll.)", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih dulu bilang 'udah makan?' tiap hari?", "romance", COUPLE_MODES, 1],
  ["Kebiasaan kecil pasangan yang bikin kesal tapi lucu?", "romance", COUPLE_MODES, 2],
  ["Kebiasaan kecil pasangan yang justru bikin nyaman?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih berantakan di kamar / meja?", "romance", COUPLE_MODES, 1],
  ["Kalau belanja bulanan, siapa yang lebih boros?", "romance", COUPLE_MODES, 1],
  ["Cara kalian bagi uang jajan / bill kencan biasanya gimana?", "romance", COUPLE_MODES, 2],
  ["Siapa yang lebih jago nyari parkir / arah jalan?", "romance", COUPLE_MODES, 1],
  ["Kalau macet bareng, suasana di mobil/motor kayak gimana?", "romance", COUPLE_MODES, 1],
  ["Tempat nongkrong 'langganan' kalian di mana?", "romance", COUPLE_MODES, 1],
  ["Siapa yang biasanya ajak ketemu duluan?", "romance", COUPLE_MODES, 1],
  ["Kalau salah satu lagi kerja/sekolah seharian, yang di rumah ngapain?", "romance", COUPLE_MODES, 1],
  ["Jam tidur ideal kalian berdua jam berapa?", "romance", COUPLE_MODES, 1],
  ["Siapa yang ngorok / gerak mulu waktu tidur? Jujur.", "romance", COUPLE_MODES, 2],
  ["Alarm siapa yang lebih bikin kesal di pagi hari?", "romance", COUPLE_MODES, 1],
  ["Kopi, teh, atau yang manis buat start hari bareng?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih sering buka HP dulu pas bangun?", "romance", COUPLE_MODES, 1],
  ["Pernah ribut karena hal sepele? Ceritain yang paling konyol.", "romance", COUPLE_MODES, 2],
  ["Kalau lagi capek, kamu lebih butuh diam atau curhat?", "romance", COUPLE_MODES, 2],
  ["Siapa yang lebih gampang ngambek, dan berapa lama normally?", "romance", COUPLE_MODES, 2],
  ["Cara damai setelah ribut kecil biasanya gimana?", "romance", COUPLE_MODES, 2],
  ["Siapa yang lebih sering bilang maaf duluan?", "romance", COUPLE_MODES, 1],
  ["Hal rumah tangga / chores yang paling kamu benci?", "romance", COUPLE_MODES, 1],
  ["Kalau libur, lebih milih tidur seharian atau jalan?", "romance", COUPLE_MODES, 1],
  ["Siapa yang jadi 'planner' kencan, siapa yang ikut aja?", "romance", COUPLE_MODES, 1],
  ["Budget kencan seminggu yang terasa pas buat kalian berapa?", "romance", COUPLE_MODES, 1],
  ["Makanan yang dilarang muncul di menu kalian (benci banget)?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih pilih-pilih makan?", "romance", COUPLE_MODES, 1],
  ["Kalau hujan deras, plan kencan kalian berubah jadi apa?", "romance", COUPLE_MODES, 1],
  ["Playlist di perjalanan bareng isinya genre apa?", "romance", COUPLE_MODES, 1],
  ["Siapa yang nyanyi lebih kenceng di mobil?", "romance", COUPLE_MODES, 1],
  ["Pernah belanja bareng sampe ribut pilih barang? Ceritain.", "romance", COUPLE_MODES, 2],
  ["Siapa yang lebih sering lupa bawa barang (charger, dompet, dll.)?", "romance", COUPLE_MODES, 1],
  ["Kalau sakit, pasanganmu tipe 'rawat total' atau 'kasih obat doang'?", "romance", COUPLE_MODES, 1],
  ["Obat / minuman yang selalu ada di tas atau meja kalian?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih sering scroll medsos pas bareng nonton?", "romance", COUPLE_MODES, 1],
  ["Game HP atau console apa yang bikin salah satu hilang 2 jam?", "romance", COUPLE_MODES, 1],
  ["Kalau pasangan main game, kamu oke atau minta gilirian?", "romance", COUPLE_MODES, 1],
  ["Rutinitas weekend kalian biasanya kayak gimana?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih males mandi / lebih lama di kamar mandi?", "romance", COUPLE_MODES, 1],
  ["Cuaca AC: dingin banget atau hangat? Siapa yang menang?", "romance", COUPLE_MODES, 1],
  ["Bantal & guling: kalian tipe berbagi atau masing-masing?", "romance", COUPLE_MODES, 1],
  ["Pernah masak bareng gagal total? Menu apa?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih jago bikin kopi / teh / indomie?", "romance", COUPLE_MODES, 1],
  ["Kalau ada tamu, siapa yang panik beres-beres dulu?", "romance", COUPLE_MODES, 1],
  ["Cara kalian bilang 'kangen' di hari biasa kayak gimana?", "romance", COUPLE_MODES, 2],
  ["Pesan paling sering dikirim selain 'ok' / 'iya' apa?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih sering read tapi telat bales?", "romance", COUPLE_MODES, 1],
  ["Kalau lagi meeting/kelas, kalian masih sempat chat gak?", "romance", COUPLE_MODES, 1],
  ["Hal remeh yang bikin hari kalian langsung lebih baik?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih sering beliin snack / es krim tiba-tiba?", "romance", COUPLE_MODES, 1],
  ["Tempat duduk favorit di cafe / warung kalian di mana?", "romance", COUPLE_MODES, 1],
  ["Kalau antri lama, siapa yang lebih gampang kesal?", "romance", COUPLE_MODES, 1],
  ["Siapa yang pegang foto-foto kenangan di galeri HP?", "romance", COUPLE_MODES, 1],
  ["Pernah salah pilih restoran bareng? Endingnya gimana?", "romance", COUPLE_MODES, 1],
  ["Olahraga bareng atau lebih suka sendiri?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih sering bilang 'nanti aja' pas disuruh sesuatu?", "romance", COUPLE_MODES, 2],
  ["Kalau duit mepet di akhir bulan, plan kencan jadi apa?", "romance", COUPLE_MODES, 2],
  ["Siapa yang lebih hemat listrik / air di rumah?", "romance", COUPLE_MODES, 1],
  ["Binatu: cuci sendiri, laundry, atau campur tugas?", "romance", COUPLE_MODES, 1],
  ["Hewan peliharaan — setuju punya bareng atau belum?", "romance", COUPLE_MODES, 1],
  ["Kalau keluarga minta ketemu, siapa yang lebih grogi?", "romance", COUPLE_MODES, 2],
  ["Cara kalian rayain hari biasa biar terasa spesial?", "romance", COUPLE_MODES, 2],
  ["Siapa yang lebih sering bikin rencana mendadak?", "romance", COUPLE_MODES, 1],
  ["Kalau hujan di rumah, makanan comfort food kalian apa?", "romance", COUPLE_MODES, 1],
  ["Satu chore yang rela kamu kerjain biar pasangan happy?", "romance", COUPLE_MODES, 2],
  ["Pagi sebelum berangkat, ritual kecil kalian apa (cium, chat, dll.)?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih sering bawa payung / jaket cadangan?", "romance", COUPLE_MODES, 1],
  ["Kalau salah satu lembur, yang satu biasanya ngapain?", "romance", COUPLE_MODES, 1],
  ["Mimpi kecil bareng yang pengen diwujudin tahun ini?", "romance", COUPLE_MODES, 2],
  ["Supermarket bareng: siapa yang isi troli, siapa yang nahan boros?", "romance", COUPLE_MODES, 1],
  ["Siapa yang lebih peka kalau pasangan lagi bad mood?", "romance", COUPLE_MODES, 2],
  ["Cara paling simpel pasangan bikin kamu seger lagi pas capek?", "romance", COUPLE_MODES, 2],
  ["Lebih suka di-chat duluan atau nge-chat duluan tiap pagi?", "romance", COUPLE_AND_CLASSIC, 1],
  ["Quality time di rumah atau jalan — mana yang lebih sering?", "romance", COUPLE_MODES, 1],
  ["Kalau pasangan main HP terus pas bareng, kamu ngomong atau diem?", "romance", COUPLE_MODES, 2],
  ["Satu kebiasaan harian yang ingin kalian bangun bareng.", "romance", COUPLE_MODES, 2],
  ["Siapa yang biasanya matiin lampu / kunci pintu?", "romance", COUPLE_MODES, 1],
  ["Snack di laci / kulkas yang 'haram' dimakan sendirian?", "romance", COUPLE_MODES, 1],
...
const DARE_SEEDS: Array<[string, Category, GameMode[], Difficulty]> = [
  ...
  ["Tebak siapa yang lebih sering belanja online di antara kalian.", "romance", COUPLE_MODES, "easy"],
  ["Sebut 3 makanan yang sering kalian makan bareng minggu ini.", "romance", COUPLE_MODES, "easy"],
  ...
  ["Buat daftar belanja darurat 10 barang di rumah tanpa liat HP.", "romance", COUPLE_MODES, "medium"],
  ...
  ["Rencanakan jadwal 1 minggu penuh bareng (kerja, makan, libur) di kertas/HP.", "romance", COUPLE_MODES, "impossible"],
  ...
  // Couple dares — aktivitas & tebak-tebakan sehari-hari
  ["Tebak sarapan favorit pasangan. Kalau salah, buatin (atau janjikan) next time.", "romance", COUPLE_MODES, "easy"],
  ["Sebut 5 item yang selalu ada di tas / meja pasangan.", "romance", COUPLE_MODES, "easy"],
  ["Rencanakan menu makan malam hemat bareng, 45 detik.", "romance", COUPLE_MODES, "easy"],
  ["Tulis daftar belanja 7 barang 'kebutuhan kita' tanpa liat HP.", "romance", COUPLE_MODES, "medium"],
  ["Tebak jam tidur pasangan biasanya. Selisih >1 jam = pijat bahu 20 dtk.", "romance", COUPLE_MODES, "easy"],
  ["Susun jadwal weekend bareng (pagi-siang-malam) dalam 1 menit.", "romance", COUPLE_MODES, "medium"],
  ["Ceritakan rutinitas pagi pasangan seakurat mungkin.", "romance", COUPLE_MODES, "medium"],
  ["Pilih film + snack malam ini, sepakat dalam 30 detik.", "romance", COUPLE_MODES, "easy"],
  ["Tebak password WiFi rumah / hotspot pasangan (petunjuk boleh).", "romance", COUPLE_MODES, "hard"],
  ["Buat aturan rumah konyol 3 poin yang kalian berdua setujui.", "romance", COUPLE_MODES, "medium"],
  ["Sebut siapa cocok cuci piring, cuci baju, buang sampah — alesan 1 kalimat.", "romance", COUPLE_MODES, "easy"],
  ["Kirim chat 'udah makan?' ke pasangan sekarang (kalau belum).", "romance", COUPLE_MODES, "easy"],
  ["Tebak pesanan ojol favorit pasangan (menu + tempat).", "romance", COUPLE_MODES, "medium"],
  ["Buat playlist 5 lagu buat perjalanan bareng, sebutin sekarang.", "romance", COUPLE_MODES, "medium"],
  ["Akuin 1 kebiasaan berantakan kamu di rumah, terus janjikan perbaiki.", "romance", COUPLE_MODES, "easy"],
  ["Tukar tugas harian 1 hari (yang masak, yang nyapu, dll.) — sepakati.", "romance", COUPLE_MODES, "medium"],
  ["Ceritakan 3 hal yang ada di kulkas / dapur kalian (atau idealnya).", "romance", COUPLE_MODES, "easy"],
  ["Rancang 'date dirumah' budget 0 rupiah, detail 1 menit.", "romance", COUPLE_MODES, "medium"],
  ["Tebak ukuran baju / sepatu pasangan.", "romance", COUPLE_MODES, "easy"],
  ["Buat alarm bersama untuk 1 habit baik (minum air, olahraga, dll.).", "romance", COUPLE_MODES, "easy"],
  ["Sebut 3 tempat makan murah yang cocok buat kalian.", "romance", COUPLE_MODES, "easy"],
  ["Roleplay: satu jadi yang telat, satu yang nunggu — 20 detik.", "romance", COUPLE_MODES, "medium"],
  ["List 4 chore minggu ini dan bagi 2-2 adil.", "romance", COUPLE_MODES, "medium"],
  ["Tebak app yang paling sering dibuka pasangan hari ini.", "romance", COUPLE_MODES, "easy"],
  ["Buat 'menu mingguan' 3 hari (sarapan/siang/malam simpel).", "romance", COUPLE_MODES, "hard"],
  ["Sebut cara paling cepet bikin pasangan ketawa di hari biasa.", "romance", COUPLE_MODES, "easy"],
  ["Janji 1 kebiasaan baru bareng mulai besok (jalan kaki, no HP dinner, dll.).", "romance", COUPLE_MODES, "medium"],
  ["Ceritakan shopping list terakhir kalian — siapa yang nambahin barang aneh?", "romance", COUPLE_MODES, "easy"],
  ["Pilih suhu AC ideal bareng, kompromi dalam 15 detik.", "romance", COUPLE_MODES, "easy"],
  ["Tebak minuman order favorit pasangan di cafe.", "romance", COUPLE_MODES, "easy"],
  ["Buat urutan antri kamar mandi pagi yang adil.", "romance", COUPLE_MODES, "easy"],
  ["Sebut 2 snack yang wajib stock di rumah.", "romance", COUPLE_MODES, "easy"],
  ["Rencanakan rute liburan 1 hari (berangkat-pulang) tanpa HP map.", "romance", COUPLE_MODES, "hard"],
  ["Akuin siapa yang lebih sering ninggalin piring di wastafel.", "romance", COUPLE_MODES, "easy"],
  ["Buat safe word konyol buat 'aku lagi capek, jangan nanya banyak'.", "romance", COUPLE_MODES, "medium"],
  ["Tebak warna baju yang paling sering dipakai pasangan.", "romance", COUPLE_MODES, "easy"],
  ["Susun budget kencan 100rb: alokasi transport, makan, jajan.", "romance", COUPLE_MODES, "medium"],
  ["Peluk atau genggam tangan 15 detik sambil sebut 1 rencana besok.", "romance", COUPLE_MODES, "easy"],
  ["Ceritakan isi laci / dompet pasangan sebisanya (tanpa liat).", "romance", COUPLE_MODES, "hard"],
  ["Sepakati jam 'no HP' bareng malam ini / minggu ini.", "romance", COUPLE_MODES, "medium"],
...
/** Generator Couple Mode — kehidupan sehari-hari */
const COUPLE_TRUTH_TEMPLATES = [
  "Siapa yang biasanya urus {x} di antara kalian berdua?",
  "Ceritakan kebiasaan kalian soal {x} di hari biasa.",
  "Pernah ribut kecil karena {x}? Endingnya gimana?",
  "Kalau soal {x}, kamu lebih cuek atau teliti?",
  "Apa yang paling kamu suka dari cara pasangan handle {x}?",
  "Satu hal soal {x} yang ingin pasanganmu ubah (sopan ya).",
  "Di rumah, {x} itu tanggung jawab siapa idealnya?",
  "Weekend kemarin, kalian ngapain soal {x}?",
  "Kalau lagi males, {x} biasanya ditunda atau dipaksa selesai?",
  "Tips random kamu biar {x} gak bikin stress berdua?",
];
...
const COUPLE_DARE_TEMPLATES: Array<[string, Difficulty]> = [
  ["Tebak kebiasaan pasangan soal {x}. Kalau salah, bilang pujian.", "easy"],
  ["Ceritakan 20 detik rutinitas kalian soal {x}.", "easy"],
  ["Bagi tugas {x} minggu ini secara adil, sebut sekarang.", "medium"],
  ["Rencanakan cara bareng biar {x} lebih gampang, 40 detik.", "medium"],
  ["Akuin siapa yang lebih males soal {x}, terus kasih solusi.", "easy"],
  ["Buat aturan rumah mini soal {x} yang kalian berdua oke.", "medium"],
  ["List 3 tips biar {x} gak bikin ribut — sebut bergantian.", "hard"],
  ["Janji 1 perubahan kecil soal {x} mulai besok.", "easy"],
];
...
function matchesModeCategories(
  ...
  // Couple Mode selalu romance — tidak tercampur sekolah/kantor/dll
...
export function generateAITruth(mode: GameMode, playerName: string): TruthCard {
  const byMode: Record<GameMode, string[]> = {
    couple: [
      `${playerName}, siapa yang biasanya masak / cuci piring di antara kalian?`,
      `${playerName}, rutinitas pagi kalian berdua kayak gimana?`,
      `${playerName}, kalau weekend di rumah, biasanya ngapain bareng?`,
      `${playerName}, kebiasaan kecil pasangan yang paling bikin nyaman sehari-hari?`,
      `${playerName}, siapa yang lebih sering telat bales chat?`,
      `${playerName}, makanan langganan order bareng apa?`,
    ],
    family: [
...
export function generateAIDare(
  ...
  const couple: Record<Difficulty, string[]> = {
    easy: [
      `${playerName}, tebak sarapan favorit pasangan!`,
      `${playerName}, sebut 3 chore yang biasanya kamu kerjain di rumah!`,
      `${playerName}, rencanakan makan malam hemat bareng, 30 detik!`,
    ],
    medium: [
      `${playerName}, susun jadwal weekend berdua (pagi-siang-malam)!`,
      `${playerName}, bagi tugas rumah minggu ini secara adil!`,
      `${playerName}, tebak app yang paling sering dibuka pasangan!`,
    ],
    hard: [
      `${playerName}, buat menu 3 hari simpel buat kalian berdua!`,
      `${playerName}, rancang date di rumah budget 0 rupiah, detail!`,
      `${playerName}, sepakati jam no-HP bareng + 1 habit baru!`,
    ],
    impossible: [
      `${playerName}, buat aturan rumah 5 poin yang berdua setujui!`,
      `${playerName}, rencanakan belanja bulanan + budget kasar 90 detik!`,
      `${playerName}, tukar chore 1 minggu penuh — tulis daftarnya!`,
    ],
  };
